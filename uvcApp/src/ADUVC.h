 ...
 *
 * This file contains the definitions of PV params, and the definition of the ADUVC class and
 * functions.
 *
 * Author: Jakub Wlodek
 * Created: July 2018
...
/* Struct for individual supported camera format - Used to auto read modes into dropdown for easier
 * operation */
...
typedef enum ADUVC_CONNECTION_TYPE { UVC_SERIAL = 0, UVC_PRODUCT_ID = 1 } ADUVC_ConnectionType_t;
...
#define ADUVC_LAST_PARAM ADUVC_PanTiltStep
   ...
   private:
    ...
    void populateCameraFormat(ADUVC_CamFormat_t* camFormat, uvc_format_desc_t* format_desc,
